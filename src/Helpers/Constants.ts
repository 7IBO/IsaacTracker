import { reducedEntities } from "@/Helpers/Enums/Entities";
...
export class Constants {
  ...
  public static readonly NUMBER_OF_ENTITIES: number =
    Object.keys(reducedEntities).length;
  ...
  public static VERSION_LOADED: VersionEnum = VersionEnum.UNDEFINED;

  public set version(version: VersionEnum) {
    Constants.VERSION_LOADED = version;
  }

  public static readonly CRC_TABLE = [
  ...
  public static readonly HEADER: Array<number> = [
    0x49, 0x53, 0x41, 0x41, 0x43, 0x4e, 0x47, 0x53, 0x41, 0x56, 0x45, 0x30,
    0x39, 0x52, 0x20, 0x20,
  ];

  // Theses offsets are 4 bytes long

  public static readonly DICTIONNARY_STATISTICS_OFFSET: Map<string, number> =
