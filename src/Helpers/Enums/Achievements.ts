...
export namespace Achievements {
  export function get(index: number): AchievementEnum {
    const values = Object.values(AchievementEnum);
  ...
  export function getAchievement(name: string): AchievementEnum {
    const achievement = Object.values(AchievementEnum).find(
      (c) => c.toString() === name,
    );
    if (achievement === undefined) {
      throw new Error("Achievement not found");
    }
    return achievement.valueOf() as AchievementEnum;
  }
}
